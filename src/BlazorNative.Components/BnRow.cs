...
/// </summary>
/// <remarks>Deliberately does NOT expose <see cref="BnView"/>'s
/// <c>Direction</c> parameter: a BnRow IS a row. Reach for <see cref="BnView"/>
/// when the direction is dynamic.</remarks>
