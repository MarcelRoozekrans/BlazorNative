...
enum BnDeepLinkVectors {
    ...
    static let all: [(url: String, route: String?)] = [
        ...
        ("blazornative://settings/audio", "/settings/audio"),
        // more than one extra segment
        ("blazornative://settings/audio/input", "/settings/audio/input"),
        // trailing slash trimmed — two spellings of one route would be a silent table miss
        ("blazornative://about/", "/about"),
        ...
        ("https://example.com/settings", nil),
    ]
}
