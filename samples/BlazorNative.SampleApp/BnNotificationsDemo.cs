...
internal sealed class BnNotificationsDemo : ComponentBase
{
    ...
    protected override void BuildRenderTree(RenderTreeBuilder b)
    {
        ...
        b.AddComponentParameter(200, nameof(BnSafeArea.ChildContent), (RenderFragment)(b2 =>
        {
            ...
            b2.AddComponentParameter(11, nameof(BnButton.Label), "Show");
            ...
            b2.AddComponentParameter(21, nameof(BnButton.Label), "Schedule");
            ...
            b2.AddComponentParameter(31, nameof(BnButton.Label), "Cancel");
