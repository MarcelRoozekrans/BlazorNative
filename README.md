...
drift in the **.NET (782)** or the **JVM `testDebugUnitTest` (120)** count **fails the
...
|---|---|---|---|
| .NET | `dotnet test` | 782 passed / 0 skipped | `ci.yml` → `build-test` — **required, gates the PR** |
